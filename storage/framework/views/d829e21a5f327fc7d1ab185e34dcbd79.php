...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.modern','data' => ['title' => __('User Analytics')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('User Analytics'))]); ?>
    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('user-analytics-simple', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2594591167-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /Users/dineshkumarvalan/git/work/TPAnalytics/resources/views/user-analytics.blade.php ENDPATH**/ ?>