    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Powerful data analytics and insights platform. <br>Transform your data into actionable business intelligence.</p>
            ...
            <div
                ...
                {{-- TP Analytics Logo --}}
                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-gray-900 dark:via-gray-800 dark:to-black">
                    <div class="text-center space-y-4">
                        {{-- Analytics Icon --}}
                        <div class="mx-auto w-24 h-24 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-2xl">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-gray-400 max-w-xs">Data-driven insights for smarter business decisions</p>
                        </div>
