                    ...
                    <div class="p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select wire:model.live="newUsersTimePeriod" 
                                        class="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div class="flex items-center space-x-2">
                                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Period:</label>
                                <select wire:model.live="activeUsersTimePeriod" 
                                        class="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="daily">Daily</option>
                                    <option value="weekly">Weekly</option>
                                    <option value="monthly">Monthly</option>
                                    <option value="yearly">Yearly</option>
...
@if(!$loading && !$error)
    <script wire:key="enhanced-charts-{{ $newUsersTimePeriod }}-{{ $activeUsersTimePeriod }}-{{ $inactiveUsersTimePeriod }}">
        document.addEventListener('DOMContentLoaded', function () {
            console.log('🎨 Initializing Enhanced Analytics Charts...');
            ...
            function createEnhancedChart(canvasId, data, config) {
                ...
                if (!isCanvasValid(canvas)) {
                    console.warn(`⏳ Canvas ${canvasId} not ready, retrying...`);
                    setTimeout(() => {
                ...
                if (charts[canvasId]) {
                    try {
                        ...
                        console.warn(`⚠️  Error destroying existing chart ${canvasId}:`, e);
                    }
                }
                ...
                try {
                    ...
                    console.log(`✅ Enhanced ${config.type} chart created: ${canvasId}`);
                } catch (error) {
            ...
            document.addEventListener('livewire:initialized', function() {
                console.log('🔄 Livewire initialized, setting up chart event listeners...');
                
                Livewire.on('newUsersChartUpdated', () => {
                    if (!isDestroyed) {
                        console.log('📈 New Users chart updated');
                ...
                Livewire.on('activeUsersChartUpdated', () => {
                    if (!isDestroyed) {
                        console.log('⚡ Active Users chart updated');
                        setTimeout(initializeCharts, 100);
                    }
                });
                ...
                Livewire.on('inactiveUsersChartUpdated', () => {
                    if (!isDestroyed) {
                        console.log('😴 Inactive Users chart updated');
                        setTimeout(initializeCharts, 100);
                    }
                });
            });
